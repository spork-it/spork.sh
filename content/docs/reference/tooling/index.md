...
Spork project commands find the nearest `spork.it`, prepare an isolated environment, and use the compatible project-local toolchain declared by that manifest. This section is the complete tooling contract for Spork 0.6.2.
