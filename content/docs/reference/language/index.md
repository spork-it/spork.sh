...
description: Complete semantics for Spork 0.6.3 lexical and reader syntax, forms, functions, types, namespaces, and Python interoperability.
section: reference
group: language
project: spork-lang
order: 90
