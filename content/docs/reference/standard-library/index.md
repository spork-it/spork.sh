...
description: Built-in values, collection operations, prelude macros, and std.* modules in Spork 0.6.2.
section: reference
...
Use this section as the standard-library contract for Spork 0.6.2. Collection literals and language forms are described in the [language reference](/docs/reference/language/); the pages here describe the values and functions available to those forms.
